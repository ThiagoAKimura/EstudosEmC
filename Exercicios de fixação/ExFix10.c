...
void main(){
    ...
    printf("Digite os 3 valores do vetor:\n");
    ...
    for(cont=0;cont<TAM;cont++){
        ...
        printf("O valor do vetor na posicao %d eh %.2f\n",cont,vetor[cont]);

    }

    media = (vetor[0] + vetor [1] + vetor [2])/3;

    printf("E a media do vetor eh: %.2f",media);


}

//Codigo do professor versão 1
...
//Código do professor versão 2 (Adaptando com o tamanho do vetor desejado)
